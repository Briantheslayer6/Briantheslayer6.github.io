...
function verifyAcres(){
   ...
   try{
      if(!(acresBox.value > 0)) {
         throw "Please enter a positive number for acres.";
      }
   }
   catch{
...
function verifyMonths() {
   try{
      if(!(monthsBox.value >= 1 && monthsBox.value <= 12)) {
         ...
         throw "Please enter a number between 1 and 12 for months.";
      }
      testFormCompleteness();
   }catch{
